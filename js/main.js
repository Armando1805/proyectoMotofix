jQuery(document).ready(function ($) {
  ...
  $('.sorting-btn.btn-list').on('click', function () {
    $('.products-items').removeClass('bs-child-width-1-2@s').addClass('bs-child-width-1-1');
  ...
  $('.sorting-btn.btn-grid').on('click', function () {
    $('.products-items').removeClass('bs-child-width-1-1').addClass('bs-child-width-1-2@s');
